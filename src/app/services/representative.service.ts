...
export class RepresentativeService {
  ...
  async getRepresentativesOverview(): Promise<FullRepresentativeOverview[]> {
    ...
    for (const representative of representatives) {
      ...
      const btcnewWeight = this.util.btcnew.rawToMbtcnew(representative.weight || 0);
  ...
  defaultRepresentatives = [
    ...
    {
      id: 'btcnew_1btcnewyaisgrmxzwwdy1w75tb1m9rxtjt6x1hykx9ubaoe4q1yyg1dh69jb',
      name: 'Seed Rep'
    },
    {
      id: 'btcnew_3yg7g4jp8yuxq7ffoasn4t5b8z7ftke8bif1c1ps9pnxmjdxuo8cn73piqhe',
      name: 'Official Rep 1'
    },
    {
