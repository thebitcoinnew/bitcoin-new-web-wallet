...
export class ReceiveComponent implements OnInit {
  ...
  async receivePending(pendingBlock) {
    ...
    const newBlock = await this.btcnewBlock.generateReceive(walletAccount, sourceBlock, this.walletService.isLedgerWallet());

    if (newBlock) {
      this.notificationService.sendSuccess(`Successfully received Btcnew!`);
    } else {
