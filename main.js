...
function createWindow () {
  ...
  // mainWindow.loadURL('https://bitcoin-new-web-wallet.io', options);
  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'View GitHub',
          click () { loadExternal('https://github.com/thebitcoinnew/bitcoin-new-web-wallet') }
        },
        {
          label: 'Submit Issue',
          click () { loadExternal('https://github.com/thebitcoinnew/bitcoin-new-web-wallet/issues/new') }
        },
        {type: 'separator'},
        {
          type: 'normal',
        ...
        },
        {
          ...
          click () { loadExternal('https://github.com/thebitcoinnew/bitcoin-new-web-wallet/releases') }
        },
        {type: 'separator'},
        {
